...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="80" y="248" font-family="DejaVu Sans, Helvetica, Arial, sans-serif" font-size="67" font-weight="bold" fill="#f1f2f4">I build things, then try</text>
  <text x="80" y="326" font-family="DejaVu Sans, Helvetica, Arial, sans-serif" font-size="67" font-weight="bold" fill="#f1f2f4">to break them.</text>
  <rect x="80" y="358" width="330" height="5" rx="2.5" fill="#8b9bff"/>
  <text x="80" y="452" font-family="DejaVu Sans Mono, monospace" font-size="25" fill="#a3aab4">Some Go, some Kubernetes, one bird detector.</text>
  <rect x="78" y="516" width="1044" height="1" fill="#23282f"/>
  <text x="80" y="570" font-family="DejaVu Sans Mono, monospace" font-size="23" fill="#6b727c">Barcelona</text>
